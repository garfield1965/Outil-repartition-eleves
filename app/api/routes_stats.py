...
def stats_ecole(db: Session = Depends(get_db)):
    ...
    - Nombre et % d'élèves par propriété (ULIS, TDAH...)
    """
    ...
    def stats_pour_annee(annee):
        ...
        for p in toutes_proprietes:
            ...
            if nb > 0 or True:  # on affiche même les zéros pour comparaison N/N+1
    ...
    return {
        "annee_n": stats_pour_annee(annee_n),
        "annee_n1": stats_pour_annee(annee_n1),
    }
